...
public class JMPlugin implements IClientPlugin, ILabelPlacer {
    ...
    @Override
    public void place(RegistryKey<World> dim, int wx, int wz, String text, int hue, DataType type, int abs, int angle) {
        ...
        Displayable label = new ImageOverlay(Cartography.MOD_ID, key, nw, se, image).setDimension(dim).setDisplayOrder(2000);
